...
from process_data import normalize_and_partition_breweries  # Replace with actual import
...
def test_normalize_and_partition_breweries(spark_session, mocker):
    ...
    mock_write_delta = mocker.patch('elt_utils.write_delta_partitioned')
    ...
    mocker.patch.object(
        spark_session, 
        'read', 
        return_value=spark_session.read.option("inferSchema", "true")
    )
    mocker.patch.object(
